...
from PyQt5.QtGui import QDoubleValidator, QIntValidator, QIcon, QPixmap
...
class DatabaseManager:
    ...
    # Получение списка всех материалов с информацией о типах
